...
students.sort(Student.compare);  // 신장 오름차순으로 배열을 정리한다.
...
humans.sort(Huamn.compare);   // 체중 오름 차순으로 정렬

humans[0].develop('JavaScript');

console.log(Huamn.planet);      // 정적 프로퍼티가 상속 되었다.
